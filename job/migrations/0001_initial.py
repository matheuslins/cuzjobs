    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tecnologies', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200, verbose_name='Tecnologies'), blank=True, null=True, size=None)),
                ('location', models.CharField(blank=True, max_length=100, null=True, verbose_name='Location')),
                ('experience_level', models.CharField(blank=True, max_length=100, null=True, verbose_name='Experience Lvel')),
                ...
                ('link_apply', models.URLField(blank=True, null=True, verbose_name='Link to Apply')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jc_candidate', to='account.Candidate', verbose_name='Candidate')),
